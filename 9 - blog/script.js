...
// 1. Je récupère le conteneur de publications
const postsContainer = document.querySelector(".posts");

// 2. Voici ma base de données fictive 
const posts = 
[
    {
...
posts.forEach(function(post) {
    // 4. Je crée un nouveau post dans le conteneur de post pour chaque post de la BDD
    const postElement = `
        <div class="post">
